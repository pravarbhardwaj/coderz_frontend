...
function Project({ myProject }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await postAPI(navigation, "/projects/project-submission/", formData, true)
    ...
    return (
      <div className="bg-white shadow-md rounded-xl p-4 border border-gray-200 hover:shadow-lg transition">
        ...
        <div className="relative">
          ...
          {!project.is_completed && <div className="ml-auto rounded-md bg-red-400 font-semibold text-white px-2">
            Pending
          </div>}
          {project.is_completed && <div className="ml-auto rounded-md bg-green-500 font-semibold text-white px-2">
            Completed
          </div>}
          </div>
        {/* Project Details */}
